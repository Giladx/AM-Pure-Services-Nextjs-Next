...
import pagePageInitialPathsD2e65Resource from '../../../resources/page-page-initial-paths-d2e65'
import pagePageInitialProps1c056Resource from '../../../resources/page-page-initial-props-1c056'
...
export async function getStaticPaths() {
  try {
    const response = await pagePageInitialPathsD2e65Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await pagePageInitialProps1c056Resource({
      ...context?.params,
    })
    if (!response) {
      return {
