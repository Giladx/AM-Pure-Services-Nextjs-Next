...
import attachmentPageInitialProps5f066Resource from '../../resources/attachment-page-initial-props-5f066'
...
export async function getStaticProps(context) {
  try {
    const response = await attachmentPageInitialProps5f066Resource({
      ...context?.params,
    })
    if (!response) {
      return {
